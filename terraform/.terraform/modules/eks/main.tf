...
# Deprecated `kubernetes_config_map` resource removed to avoid provider deprecation warnings.
# The module now uses `kubernetes_config_map_v1_data` to manage the aws-auth configmap.
# Original resource block was intentionally removed by local override.
